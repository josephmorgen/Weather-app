package com.example.airy.airycoolweather.service;
...
public class AutoUpdateService extends Service {
    ...
    //更新天气，发起网络请求，请求成功则解析返回的天气数据并存入缓存
    private void updateWeather(){
        ...
        if(weatherString!=null) {
            ...
            String weatherUrl = "http://guolin.tech/api/weather?cityid=" + weatherId + "&key=65154046739f4cd08f5d691bfcbd1c65";
